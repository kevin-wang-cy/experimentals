...
curl -H "Authorization: Bearer 0cbe4708-3d8e-43c8-9904-2d165a54875e" -v localhost:8801/rs/user | jq .
...
curl -H "Authorization: Bearer 0b92e94e-166e-4e83-9d2b-1e787d4a55af" -v localhost:8801/rs/user | jq .
...
curl -H "Authorization: Bearer 37d2e42d-d0fa-48ed-9365-b75ec2e8787f" -v localhost:8801/rs/ | jq .
...
curl -vv -u "svc-account-2:svc-account-2-secret" -X POST "http://localhost:9801/auth/oauth/token" -d grant_type=client_credentials | jq .
...
curl -H "Authorization: Bearer 88240c75-d51f-4093-9cf4-9734ae512ff9" -v localhost:8801/rs/ | jq .
...
curl -vv -u "svc-account-4:svc-account-4-secret" -X POST "http://localhost:9801/auth/oauth/token" -d grant_type=client_credentials | jq .
...
curl -H "Authorization: Bearer 5ab85813-9ab8-4e04-9b62-f36fb5967362" -v localhost:8801/rs/ | jq .
...
curl -H "Authorization: Bearer 5ab85813-9ab8-4e04-9b62-f36fb5967362" -v localhost:8801/rs/user | jq .
{
  "error": "access_denied",
  "error_description": "Access is denied"
}
...
curl -H "Authorization: Bearer a2f94c98-9e0d-4d9b-ac38-2c95b53ff990" -v localhost:8801/rs/user | jq .
...
curl -H "Authorization: Bearer 4e2f86fc-78af-4004-b992-152f1e73366f" -v localhost:8801/rs/user | jq .
...
curl -H "Authorization: Bearer c5987650-eb28-43db-b64a-14c79e18d2c0" -v localhost:8801/rs/user | jq .
